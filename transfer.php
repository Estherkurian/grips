...
<body>
    ...
    <ul>
      ...
      <div class="main">
        <br><u style="font-weight: 400; font-size: 35px;">Customer List for Transfer</u><br><br>
        <?php
          ...
          <th width='500'>Account Number</th>
          <th width='300'>Select Account to transfer money</th>
          </tr>";
          while($row=mysqli_fetch_array($result))
          {
              ...
              echo "<th><button onclick='window.location.href=\"transfer_cust.php?name=".urlencode($row['Account_number'])."\";'>Transfer</button></th>";
              echo "</tr>";
          }
          echo "</table>";
          mysqli_close($conn);
